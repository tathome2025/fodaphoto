import{r as C,D as P,d as h,E as I,y as w,A as L,p as f,q as S,P as x,F as E}from"./workbench-4gzxfYMo.js";const o={photos:[],groups:[],selectedPhotoIds:new Set};let c=null;const a={currentUserEmail:document.querySelector("#currentUserEmail"),galleryMeta:document.querySelector("#galleryMeta"),galleryCountChip:document.querySelector("#galleryCountChip"),gallerySelectedChip:document.querySelector("#gallerySelectedChip"),deleteSelectedBtn:document.querySelector("#deleteSelectedBtn"),galleryStatus:document.querySelector("#galleryStatus"),galleryDateList:document.querySelector("#galleryDateList"),galleryLightbox:document.querySelector("#galleryLightbox"),galleryLightboxClose:document.querySelector("#galleryLightboxClose"),galleryLightboxImage:document.querySelector("#galleryLightboxImage"),galleryLightboxTitle:document.querySelector("#galleryLightboxTitle"),galleryLightboxSubtitle:document.querySelector("#galleryLightboxSubtitle"),galleryLightboxOperator:document.querySelector("#galleryLightboxOperator")};function k(e){a.currentUserEmail&&(a.currentUserEmail.textContent=e?.email||e?.phone||e?.id||"-")}function s(e,t){a.galleryStatus.textContent=e,a.galleryStatus.className="status-text",t&&a.galleryStatus.classList.add(`is-${t}`)}function q(){return o.selectedPhotoIds.size}function y(){const e=q();a.gallerySelectedChip&&(a.gallerySelectedChip.textContent=e?`已選 ${e} 張`:"未選取相片"),a.deleteSelectedBtn&&(a.deleteSelectedBtn.disabled=e===0)}function u(e){const t=e.captureSet?.brandName||"未關聯品牌",l=e.captureSet?.vehicleModel?` ${e.captureSet.vehicleModel}`:"";return`${t}${l}`}function v(e){return e.kind==="vehicle"?"Check-in 車輛照":e.itemLabel||"未分類工序"}function $(e){const t=[],l=new Map;return e.forEach(d=>{const r=I(d.createdAt);if(!l.has(r)){const n={dateKey:r,photos:[]};l.set(r,n),t.push(n)}l.get(r).photos.push(d)}),t}function D(e){const t=e.captureSet?.reference||"未關聯案件",l=o.selectedPhotoIds.has(e.id);return`
